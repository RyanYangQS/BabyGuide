...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,10.211.171.149";
  const port = "8090";
  const id = "mp-weixin_rGbDYl";
      ...
      t2.en.relativeTime = o2, n2.fromToBase = function(e3, n3, i2, d2, u) {
        for (var f2, a, s, l = i2.$locale().relativeTime || o2, h = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m = h.length, c = 0; c < m; c += 1) {
          ...
          if (s = f2 > 0, p2 <= y.r || !y.r) {
            p2 <= 1 && c > 0 && (y = h[c - 1]);
            var v = l[y.l];
            u && (p2 = u("" + p2)), a = "string" == typeof v ? v.replace("%d", p2) : v(p2, n3, y.l, s);
            break;
          }
        }
        if (n3)
...
var util = {
  ...
  isCollision: function isCollision(obj1, obj2) {
    ...
    var flag2 = obj2.start.x > obj1.end.x || obj2.end.x < obj1.start.x || obj2.end.y > obj1.start.y || obj2.start.y < obj1.end.y;
    return !flag2;
  }
};
...
function getCandleToolTipData(series, seriesData, opts, index2, categories, extra) {
  ...
  let color2 = [upColor, upColor, downColor, upColor];
  var textList = [];
...
function getXAxisTextList(series, opts, config2, stack2) {
  ...
  for (var i = 0; i <= opts.xAxis.splitNumber; i++) {
    range2.push(minRange + eachRange * i);
  }
  return range2;
}
...
function calMarkLineData(points, opts) {
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    let range2 = [].concat(opts.chartData.yAxisData.ranges[points[i].yAxisIndex]);
    minRange = range2.pop();
    maxRange = range2.shift();
...
function drawPointShape(points, color2, shape, context, opts) {
  context.beginPath();
...
function drawActivePoint(points, color2, shape, context, opts, option, seriesIndex) {
  if (!opts.tooltip) {
    return;
  }
...
var uCharts = function uCharts2(opts) {
  ...
  if (!this.context.setTextAlign) {
    ...
    this.context.setShadow = function(offsetX, offsetY, blur, color2) {
...
uCharts.prototype.zoom = function() {
  ...
  if (this.opts.enableScroll !== true) {
    index$1.__f__("log", "at node_modules/@qiun/ucharts/u-charts.js:7193", "[uCharts] 请启用滚动条后使用");
    return;
  }
...
uCharts.prototype.dobuleZoom = function(e2) {
  if (this.opts.enableScroll !== true) {
    index$1.__f__("log", "at node_modules/@qiun/ucharts/u-charts.js:7233", "[uCharts] 请启用滚动条后使用");
    return;
  }
...
uCharts.prototype.showToolTip = function(e2) {
  ...
  if (!touches) {
    index$1.__f__("log", "at node_modules/@qiun/ucharts/u-charts.js:7411", "[uCharts] 未获取到event坐标信息");
  }
